...
function ProjectDetails() {
   ...
   *
   * Examples:
   * Loading:            "Loading Project | Sourov Chandra Adikari"
   * Successful project: "SCA Courier | Sourov Chandra Adikari"
      ...
      <PageFrame>
        <AboutSection
          portfolio={{
            ...
            experienceYears: Math.max(1, new Date().getFullYear() - 2023),
          }}
        />
        ...
        <section className="max-w-7xl mx-auto w-full px-5 md:px-6 pb-20">
          <div className="mb-7">
            ...
            <p className="text-base text-muted-foreground max-w-2xl">
              A focused overview of my technical expertise, development
              stack, and professional traits.
            </p>
          </div>
      ...
      <PageFrame>
        <section className="max-w-7xl mx-auto w-full">
          <div className="px-5 md:px-6 mb-3">
            ...
            <h1 className="text-3xl md:text-5xl font-bold tracking-tight">
              Education & <span className="text-gradient-primary">Learning</span>
            </h1>
          </div>

          <EducationSection education={data.education} skills={data.skills} />
        </section>
      </PageFrame>
    );
  }
